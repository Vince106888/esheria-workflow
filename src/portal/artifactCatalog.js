...
export const portalSections = [
  ...
  },
  {
    ...
    navLabel: "Documents",
    title: "Documents",
    description: "Decision-ready PDFs and source documents for executive and technical review.",
    bestFor: "Formal review sessions, document handoff, and architecture alignment records.",
    reviewHint: "Start with PDFs in meetings; use source docs and discovery notes for deep follow-up.",
    items: [
      {
        label: "Executive Proposal (PDF)",
        url: "/artifacts/exports/pdf/executive_proposal.pdf",
      ...
      },
      {
        ...
        url: "/artifacts/esheria-executive-proposal.docx",
        type: "Editable DOCX",
        summary: "Word version for stakeholder edits and tracked changes.",
      },
      {
        label: "Technical Blueprint (DOCX)",
        url: "/artifacts/esheria-technical-blueprint.docx",
        type: "Editable DOCX",
        summary: "Word version of the implementation blueprint.",
      },
      {
        label: "Product Design Appendix (DOCX)",
        url: "/artifacts/esheria-product-design-appendix.docx",
        type: "Editable DOCX",
        summary: "Design appendix in editable Word format.",
      },
      {
        label: "Executive Proposal (LaTeX)",
        url: "/artifacts/documents/executive_proposal.tex",
        type: "Source Document",
        summary: "Source for executive PDF generation and versioning.",
      },
      {
        label: "Technical Blueprint (LaTeX)",
        url: "/artifacts/documents/technical_blueprint.tex",
        type: "Source Document",
        summary: "Source for technical PDF generation and updates.",
      },
      {
        label: "API Catalog",
